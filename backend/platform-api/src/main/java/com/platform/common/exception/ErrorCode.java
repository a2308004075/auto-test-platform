...
public final class ErrorCode {
    ...
    public static final int CONTENT_TEMPLATE_NOT_FOUND = 2106;
    public static final int CONTENT_TEMPLATE_NAME_DUPLICATE = 2107;
    ...
    public static int toHttpStatus(int errorCode) {
        ...
        switch (errorCode) {
            ...
            case CONTENT_TEMPLATE_NOT_FOUND:
            ...
            case CONTENT_TEMPLATE_NAME_DUPLICATE:
                return 409;
